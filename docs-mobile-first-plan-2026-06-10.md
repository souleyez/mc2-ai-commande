...
sealed through PC1-PC83, including the PC core playable contract check, mobile
...
Phone product constraint: 手机端首版固定横屏横版; portrait/vertical play is not in the first playable slice.
