...
inventory refresh binding is complete. The next formal task is
...
Completed formal task -> F15 plan server-backed receipt slice. Completed formal task -> F16 implement server-backed receipt evidence gate. Completed formal task -> F17 plan post-receipt inventory refresh boundary. Completed formal task -> F18 implement opt-in post-receipt inventory refresh binding. Next formal task -> F19 capture opt-in post-receipt refresh evidence.
```
...
- F19 capture opt-in post-receipt refresh evidence. This is the next formal task and should capture debrief reward text, MechBay source line, duplicate-claim no-double-apply behavior, and horizontal phone layout evidence.
