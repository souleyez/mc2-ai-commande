...
landscape touch UI ergonomics, F22 landscape MechLab touch controls and F23
landscape MechLab touch evidence are complete. The next formal task is `F24
capture Android MechLab touch evidence`.
