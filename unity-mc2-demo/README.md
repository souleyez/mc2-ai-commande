...
- draws a thin commander-to-objective route line with endpoint markers for the current active battlefield target
...
- draws tactical target lines from player units to active targets, with weapon-readiness color and target endcaps
...
- includes `mc2_01-solo-order-state.txt` as the single-unit order smoke path for the detached solo count and solo-order cue contract
...
- estimates contract bounty, repair cost, net funds result, salvage claims, and destroyed target summaries in mission debriefs
- shows a compact debrief Outcome row for objectives, kills, player damage, net funds, and salvage
- summarizes completed objectives, enemy kills, destroyed targets, and damaged player mechs with compact section damage tags in the debrief without expanding the panel
...
- resolves temporary weapon cooldown, damage, cockpit/torso/arms/legs sections,
  and destruction
- keeps destroyed cockpit, arm, and leg sections readable from the tactical view, including a short cockpit ejection chute, landing beacon, and landing smoke cue
- makes full mech destruction read harder with short wreck debris pieces layered over blast, smoke, and scorch markers
