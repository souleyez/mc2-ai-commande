...
- exposes the same Save Choices entry from the pause/system panel, with Save Current, inline Last Save feedback, Back support, and an explicit New Game confirmation that resets the active demo run while keeping the persistent default save
