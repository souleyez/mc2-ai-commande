...
- shows a fixed combat Tempo row for quiet, contact, tracking, or fire states so pressure is readable without scanning the log
- splits active hostile pressure into a compact Contacts row by source encounter group, such as Air, North, Amb, and Star
