...
- includes `mc2_01-salvage-wrecks.txt` as the natural-kill smoke path for compact battle salvage count and hostile wreck readability
...
- shows a compact combat situation row for squad readiness, active hostiles, live targets, target focus, contact tempo, and salvage count only after hostile wrecks exist
