...
| F26 | Next | `Reduce Android combat effect log noise` | 基于 F25 真机 logcat 发现的 CreatePrimitive collider 噪声，把战斗特效改为 Android 友好的无 collider 几何/材质生成路径，降低 logcat 噪声和测试负载，同时保持横屏战斗画面证据稳定 | Android combat effect log noise gate |
