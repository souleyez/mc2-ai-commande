...
| F28 | Next | `Capture Android entity placeholder collision runtime evidence` | 在已连接 Android 横屏 APK 上捕获实体/建筑/硬 prop 占位碰撞运行证据，验证侧车摘要和真机 logcat 仍保持 overlap=0、collision/pathing unchanged、无 Collider 类缺失噪声 | Android runtime collision evidence |
