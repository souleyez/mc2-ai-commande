...
| F21 | Next | `Audit landscape touch UI ergonomics` | 基于 F20 横屏真机证据检查战斗 HUD、状态栏、喷射/系统按钮和 MechLab 在 2400x1080 横屏手机上的触控尺寸、遮挡和信息密度，继续排除竖屏首版支持 | landscape touch UI audit |
