...
| F41 | Next | `Audit post-F40 PC controlled-demo investor evidence package` | Audit the refreshed F40 PC investor evidence package for presentation readiness, visible damage/debrief story, proxy-art clarity, sparse HUD fit and mobile landscape boundary before the next fix slice. | PC investor evidence package audit |
