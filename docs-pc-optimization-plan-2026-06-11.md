...
- Current plan queue, current plan gate, handoff and mobile command preflight accept PC1-PC75.
...
- Current plan queue, current plan gate, handoff and mobile command preflight accept PC1-PC75, `Pass Android G3 device smoke` and `G4 Touch UI pass`.
