...
- Public replacement content slice 已打开，`Polish MechLab grid feel` 和 `Prove loadout battle effects` 已完成，下一步是 `Polish weapon and damage readability`.
...
| Demo handoff 已刷新 | Full refresh 已验证 build、smoke、capture 和 boundary；V4 contact-spread evidence 已纳入证据页 | Polish weapon and damage readability |
...
| 21 | Next | `Polish weapon and damage readability` | G1 combat feel |
