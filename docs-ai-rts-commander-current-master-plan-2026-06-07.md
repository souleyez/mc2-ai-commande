...
```text
Mobile G3 Passed -> G4 Touch UI pass
```
...
- AI 副官是可选能力，不拖慢本地战斗；
- 公开替换包路线讲得清楚；
- Android G3 真机 smoke 已通过；下一步进入 G4 Touch UI pass。
