...
| 156 | Next | `Implement post-F77 PC controlled-demo investor route evidence refresh audit fixes` | Make F77 audit findings and follow-ups visible in plan, evidence and handoff surfaces, close the F79 consume-F77-audit-report contract, and keep the new F78 script/output path short. | PC investor route evidence refresh audit fixes |
