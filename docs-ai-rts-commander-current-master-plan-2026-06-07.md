...
| 92 | Next | `Capture landscape-phone MechLab source-line evidence` | 用横版手机比例捕获 MechLab 库存来源行/装配界面证据，确认首版手机端横版布局不拥挤、不引入竖屏目标 | capture/evidence gate |
