...
| 123 | Next | `Implement post-F44 PC controlled-demo investor evidence polish fixes` | Apply the F44 follow-ups: compact route summary, explicit damage-demo screenshot/sidecar links, visible landscape-phone proof line and easier proxy-language parsing. | PC investor evidence polish fixes |
