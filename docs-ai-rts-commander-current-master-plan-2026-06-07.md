...
| 107 | Next | `Audit PC controlled-demo visual readability` | 回到 PC 端优化，基于当前碰撞/sidecar 证据审计 spawn、hangar-contact、damage-demo 的单位、建筑、地形和稀疏 HUD 可读性，输出下一轮视觉修正清单 | PC visual readability audit |
