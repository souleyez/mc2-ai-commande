...
| 91 | Next | `Capture opt-in MechBay preview evidence` | 捕获或记录 MechBay 库存来源行和 opt-in 预览证据，默认 Demo、本地 fixture、BattleCore 帧循环和手机横版布局保持不变 | capture/evidence gate |
