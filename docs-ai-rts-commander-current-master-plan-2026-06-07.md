...
| 159 | Next | `Implement post-F80 PC controlled-demo investor route evidence refresh audit fixes` | Make F80 audit findings and follow-ups visible in plan, evidence and handoff surfaces, close the F82 consume-F80-audit-report contract, and keep the new F81 script/output path short. | PC investor route evidence audit fixes |
