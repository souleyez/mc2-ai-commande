...
```text
F24 Android MechLab touch evidence sealed -> F25 capture Android battle command touch evidence
```
...
| 103 | Next | `Capture Android battle command touch evidence` | 在已连接 Android 横屏 APK 上捕获战斗指挥触控证据，验证状态栏单选、默认全队、移动/集火、喷射、任务地图/系统入口和稀疏 HUD 在真机横版布局下可用 | Android battle command touch device evidence |
