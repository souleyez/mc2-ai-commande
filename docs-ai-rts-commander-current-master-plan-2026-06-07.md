...
```text
F23 landscape MechLab touch evidence sealed -> F24 capture Android MechLab touch evidence
```
...
| 102 | Next | `Capture Android MechLab touch evidence` | 在已连接 Android 横屏 APK 上捕获 MechLab touch 截图、logcat 和 summary，验证真机横屏装配按钮、格子触控和 F23 Windows phone-ratio 证据一致，继续排除竖屏首版支持 | Android MechLab touch device evidence |
