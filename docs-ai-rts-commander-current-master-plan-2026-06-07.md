...
| 93 | Next | `Plan server-backed receipt slice` | 规划主服务器下一步战斗回执、奖励、库存和排行榜最小实现切片，保持 BattleCore 帧循环和本地 Demo 离线优先 | plan/gate |
