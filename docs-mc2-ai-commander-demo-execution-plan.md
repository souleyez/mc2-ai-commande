...
- selected target status and payload detail text now echo that filler action beside weapon-placement state
...
- The target status and payload detail line now echo that next filler action beside the weapon-placement state.
