...
- the payload detail line now reports target clear/blocked status plus selected weapon footprint cells
...
- The payload detail line now mirrors target placement state in text, including clear/blocked status and selected weapon footprint cells.
