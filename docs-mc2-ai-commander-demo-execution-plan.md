...
Start with **starter depot pilot hire preview**.
...
- The remaining visible blocker for depot fitting is pilot assignment, so the next low-risk step is a read-only NPC pilot hire preview before enabling real hiring, friend pilots, or pilot death.
