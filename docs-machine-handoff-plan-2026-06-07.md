...
- Latest sealed PC/mobile wait-state checkpoint: `PC1-PC44`
- Last completed PC checkpoint: `Add PC launch log hygiene check`
...
**Step 16: Run current plan gate check**
...
deputy contract, mobile command model, battle HUD sparse contract, PC visual capture sanity, PC visual capture sanity self-test, PC capture sidecar schema, PC capture preset contract, PC capture artifact hygiene, PC window contract, PC launch log hygiene and Android
...
**Step 17: Self-test Android smoke log scanning**
...
**Step 18: Self-test Android smoke summary schema**
...
**Step 19: Preview Android device smoke plan**
...
**Step 20: Check Android smoke plan/preflight consistency**
...
**Step 21: Run Android G3 readiness directly**
...
**Step 22: Confirm strict G3 device requirement**
...
**Step 23: Run Android device-smoke preflight directly if needed**
...
**Step 24: Set paths for rebuilding evidence if needed**
...
**Step 25: Run validator when rebuilding or auditing from scratch**
...
**Step 26: Build Windows player when rebuilding or auditing from scratch**
...
**Step 27: Run visible-flow smoke without AI key when rebuilding or auditing from scratch**
