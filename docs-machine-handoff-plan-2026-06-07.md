...
- Current formal next development task after handoff: `F40 refresh PC controlled-demo investor-readiness evidence after fixes`
- Mobile orientation decision retained for handoff: first phone version is landscape-only; portrait is not a first-slice support target.
...
- `scripts/unity/check_inventory_mechbay_binding_boundary.ps1` prints `Inventory-to-MechBay binding boundary check OK`.
...
- Next planned work: `F40 refresh PC controlled-demo investor-readiness evidence after fixes`
