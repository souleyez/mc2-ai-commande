...
- Current formal next development task after handoff: `F39 implement post-F37 PC controlled-demo investor readiness fixes`
...
- Next planned work: `F39 implement post-F37 PC controlled-demo investor readiness fixes`
