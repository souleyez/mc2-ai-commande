...
$pcControlledDemoInvestorRouteEvidenceAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditScript = Resolve-RepoPath -RelativePath "scripts\unity\audit_pc_controlled_demo_investor_route_evidence_audit_fix_refresh_audit_fix_refresh_audit_fix_refresh_audit_fix_refresh_audit_fix_refresh_audit_fix_refresh_audit_fix_refresh_audit.ps1"
$pcControlledDemoInvestorRouteEvidenceAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixesScript = Resolve-RepoPath -RelativePath "scripts\unity\check_pc_controlled_demo_investor_route_evidence_audit_fix_refresh_audit_fix_refresh_audit_fix_refresh_audit_fix_refresh_audit_fix_refresh_audit_fix_refresh_audit_fix_refresh_audit_fixes.ps1"
$pcControlledDemoInvestorRouteEvidenceAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshScript = Resolve-RepoPath -RelativePath "scripts\unity\check_f70_pc_route_evidence_refresh.ps1"
...
$f75PcRouteAuditFixesScript = Resolve-RepoPath -RelativePath "scripts\unity\check_f75_pc_route_audit_fixes.ps1"
$f76PcRouteEvidenceRefreshScript = Resolve-RepoPath -RelativePath "scripts\unity\check_f76_pc_route_evidence_refresh.ps1"
$f77PcRouteEvidenceRefreshAuditScript = Resolve-RepoPath -RelativePath "scripts\unity\audit_f77_pc_route_evidence_refresh.ps1"
$f78PcRouteAuditFixesScript = Resolve-RepoPath -RelativePath "scripts\unity\check_f78_pc_route_audit_fixes.ps1"
$f79PcRouteEvidenceRefreshScript = Resolve-RepoPath -RelativePath "scripts\unity\check_f79_pc_route_evidence_refresh.ps1"
$f80PcRouteEvidenceRefreshAuditScript = Resolve-RepoPath -RelativePath "scripts\unity\audit_f80_pc_route_evidence_refresh.ps1"
$f81PcRouteAuditFixesScript = Resolve-RepoPath -RelativePath "scripts\unity\check_f81_pc_route_audit_fixes.ps1"
$f82PcRouteEvidenceRefreshScript = Resolve-RepoPath -RelativePath "scripts\unity\check_f82_pc_route_evidence_refresh.ps1"
$f83PcRouteEvidenceRefreshAuditScript = Resolve-RepoPath -RelativePath "scripts\unity\audit_f83_pc_route_evidence_refresh.ps1"
$f84PcRouteAuditFixesScript = Resolve-RepoPath -RelativePath "scripts\unity\check_f84_pc_route_audit_fixes.ps1"
...
Invoke-GateStep `
    -Name "PC controlled-demo investor route evidence audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit plan gate" `
    -ScriptPath $pcControlledDemoInvestorRouteEvidenceAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("PC controlled-demo investor route evidence audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit plan OK.")

Invoke-GateStep `
    -Name "PC controlled-demo investor route evidence audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fixes plan gate" `
    -ScriptPath $pcControlledDemoInvestorRouteEvidenceAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixesScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("PC controlled-demo investor route evidence audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fixes plan OK.")

Invoke-GateStep `
    -Name "PC controlled-demo investor route evidence audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh plan gate" `
    -ScriptPath $pcControlledDemoInvestorRouteEvidenceAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshAuditFixRefreshScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("PC controlled-demo investor route evidence audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh audit fix refresh plan OK.")

Invoke-GateStep `
    -Name "F71 PC route evidence refresh audit plan gate" `
    -ScriptPath $f71PcRouteEvidenceRefreshAuditScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F71 PC route evidence refresh audit plan OK.")

Invoke-GateStep `
    -Name "F72 PC route audit fixes plan gate" `
    -ScriptPath $f72PcRouteAuditFixesScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F72 PC route audit fixes plan OK.")

Invoke-GateStep `
    -Name "F73 PC route evidence refresh plan gate" `
...
Invoke-GateStep `
    -Name "F75 PC route audit fixes plan gate" `
    -ScriptPath $f75PcRouteAuditFixesScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F75 PC route audit fixes plan OK.")

Invoke-GateStep `
    -Name "F76 PC route evidence refresh plan gate" `
    -ScriptPath $f76PcRouteEvidenceRefreshScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F76 PC route evidence refresh plan OK.")

Invoke-GateStep `
    -Name "F77 PC route evidence refresh audit plan gate" `
    -ScriptPath $f77PcRouteEvidenceRefreshAuditScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F77 PC route evidence refresh audit plan OK.")

Invoke-GateStep `
    -Name "F78 PC route audit fixes plan gate" `
    -ScriptPath $f78PcRouteAuditFixesScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F78 PC route audit fixes plan OK.")

Invoke-GateStep `
    -Name "F79 PC route evidence refresh plan gate" `
    -ScriptPath $f79PcRouteEvidenceRefreshScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F79 PC route evidence refresh plan OK.")

Invoke-GateStep `
    -Name "F80 PC route evidence refresh audit plan gate" `
    -ScriptPath $f80PcRouteEvidenceRefreshAuditScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F80 PC route evidence refresh audit plan OK.")

Invoke-GateStep `
    -Name "F81 PC route audit fixes plan gate" `
    -ScriptPath $f81PcRouteAuditFixesScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F81 PC route audit fixes plan OK.")

Invoke-GateStep `
    -Name "F82 PC route evidence refresh plan gate" `
    -ScriptPath $f82PcRouteEvidenceRefreshScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F82 PC route evidence refresh plan OK.")

Invoke-GateStep `
    -Name "F83 PC route evidence refresh audit plan gate" `
    -ScriptPath $f83PcRouteEvidenceRefreshAuditScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F83 PC route evidence refresh audit plan OK.")

Invoke-GateStep `
    -Name "F84 PC route audit fixes plan gate" `
    -ScriptPath $f84PcRouteAuditFixesScript `
    -Arguments @("-RepoRoot", $RepoRoot, "-PlanOnly") `
    -RequiredMarkers @("F84 PC route audit fixes plan OK.")
