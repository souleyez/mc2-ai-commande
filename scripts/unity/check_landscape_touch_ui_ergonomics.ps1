...
Assert-Contains -Text $masterPlan -Needle '| 100 | Next | `Audit landscape MechLab touch controls` |' -Label "master plan F22"
Assert-Contains -Text $detailedPlan -Needle '| F21 | Done | `Audit landscape touch UI ergonomics` |' -Label "detailed plan F21"
Assert-Contains -Text $detailedPlan -Needle '| F22 | Next | `Audit landscape MechLab touch controls` |' -Label "detailed plan F22"
...
Add-OkRow -Check "plan docs" -Detail "F21 done, F22 next"
