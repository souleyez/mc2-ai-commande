...
Require-Text -Text $handoff -Needle 'Current formal next development task after handoff: `F38 audit post-F37 PC controlled-demo investor readiness`' -Label "handoff next task"
Require-Text -Text $handoff -Needle 'Next planned work: `F38 audit post-F37 PC controlled-demo investor readiness`' -Label "handoff next planned work"
