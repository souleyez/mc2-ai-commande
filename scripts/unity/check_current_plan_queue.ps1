...
Assert-Contains -Text $mobilePlan -Needle "F27 audit Android entity placeholder collision path" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F27 | Next | `Audit Android entity placeholder collision path` |' -Label "detailed queue F27"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F27 audit Android entity placeholder collision path`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F27 audit Android entity placeholder collision path`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F27 audit Android entity placeholder collision path' -Label "handoff script F27 next task marker"
