...
Assert-Contains -Text $mobilePlan -Needle "F55 refresh PC controlled-demo investor route evidence after F53 audit fixes" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F55 | Next | `Refresh PC controlled-demo investor route evidence after F53 audit fixes` |' -Label "detailed queue F55"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F55 refresh PC controlled-demo investor route evidence after F53 audit fixes`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F55 refresh PC controlled-demo investor route evidence after F53 audit fixes`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F55 refresh PC controlled-demo investor route evidence after F53 audit fixes' -Label "handoff script F55 next task marker"
