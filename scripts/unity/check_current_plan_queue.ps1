...
Assert-Contains -Text $mobilePlan -Needle "F62 audit post-F61 PC controlled-demo investor route evidence refresh" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F62 | Next | `Audit post-F61 PC controlled-demo investor route evidence refresh` |' -Label "detailed queue F62"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F62 audit post-F61 PC controlled-demo investor route evidence refresh`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F62 audit post-F61 PC controlled-demo investor route evidence refresh`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F62 audit post-F61 PC controlled-demo investor route evidence refresh' -Label "handoff script F62 next task marker"
