...
Assert-Contains -Text $mobilePlan -Needle "F35 audit post-F34 PC controlled-demo playable flow polish" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F35 | Next | `Audit post-F34 PC controlled-demo playable flow polish` |' -Label "detailed queue F35"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F35 audit post-F34 PC controlled-demo playable flow polish`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F35 audit post-F34 PC controlled-demo playable flow polish`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F35 audit post-F34 PC controlled-demo playable flow polish' -Label "handoff script F35 next task marker"
