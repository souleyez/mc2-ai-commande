...
Assert-Contains -Text $mobilePlan -Needle "F80 audit post-F79 PC controlled-demo investor route evidence refresh" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F80 | Next | `Audit post-F79 PC controlled-demo investor route evidence refresh` |' -Label "detailed queue F80"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F80 audit post-F79 PC controlled-demo investor route evidence refresh`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F80 audit post-F79 PC controlled-demo investor route evidence refresh`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F80 audit post-F79 PC controlled-demo investor route evidence refresh' -Label "handoff script F80 next task marker"
