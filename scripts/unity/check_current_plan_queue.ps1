...
Assert-Contains -Text $mobilePlan -Needle "F67 refresh PC controlled-demo investor route evidence after F65 audit fixes" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F67 | Next | `Refresh PC controlled-demo investor route evidence after F65 audit fixes` |' -Label "detailed queue F67"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F67 refresh PC controlled-demo investor route evidence after F65 audit fixes`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F67 refresh PC controlled-demo investor route evidence after F65 audit fixes`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F67 refresh PC controlled-demo investor route evidence after F65 audit fixes' -Label "handoff script F67 next task marker"
