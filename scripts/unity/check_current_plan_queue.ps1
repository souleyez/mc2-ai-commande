...
Assert-Contains -Text $mobilePlan -Needle "F71 audit post-F70 PC controlled-demo investor route evidence refresh" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F71 | Next | `Audit post-F70 PC controlled-demo investor route evidence refresh` |' -Label "detailed queue F71"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F71 audit post-F70 PC controlled-demo investor route evidence refresh`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F71 audit post-F70 PC controlled-demo investor route evidence refresh`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F71 audit post-F70 PC controlled-demo investor route evidence refresh' -Label "handoff script F71 next task marker"
