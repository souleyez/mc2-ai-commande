...
Assert-Contains -Text $mobilePlan -Needle "F79 refresh PC controlled-demo investor route evidence after F77 audit fixes" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F79 | Next | `Refresh PC controlled-demo investor route evidence after F77 audit fixes` |' -Label "detailed queue F79"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F79 refresh PC controlled-demo investor route evidence after F77 audit fixes`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F79 refresh PC controlled-demo investor route evidence after F77 audit fixes`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F79 refresh PC controlled-demo investor route evidence after F77 audit fixes' -Label "handoff script F79 next task marker"
