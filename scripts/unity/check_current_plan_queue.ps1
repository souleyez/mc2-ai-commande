...
Assert-Contains -Text $mobilePlan -Needle "F78 implement post-F77 PC controlled-demo investor route evidence refresh audit fixes" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F78 | Next | `Implement post-F77 PC controlled-demo investor route evidence refresh audit fixes` |' -Label "detailed queue F78"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F78 implement post-F77 PC controlled-demo investor route evidence refresh audit fixes`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F78 implement post-F77 PC controlled-demo investor route evidence refresh audit fixes`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F78 implement post-F77 PC controlled-demo investor route evidence refresh audit fixes' -Label "handoff script F78 next task marker"
