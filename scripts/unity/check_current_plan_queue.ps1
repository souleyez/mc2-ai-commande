...
Assert-Contains -Text $mobilePlan -Needle "F66 implement post-F65 PC controlled-demo investor route evidence refresh audit fixes" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F66 | Next | `Implement post-F65 PC controlled-demo investor route evidence refresh audit fixes` |' -Label "detailed queue F66"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F66 implement post-F65 PC controlled-demo investor route evidence refresh audit fixes`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F66 implement post-F65 PC controlled-demo investor route evidence refresh audit fixes`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F66 implement post-F65 PC controlled-demo investor route evidence refresh audit fixes' -Label "handoff script F66 next task marker"
