...
Assert-Contains -Text $mobilePlan -Needle "F40 refresh PC controlled-demo investor-readiness evidence after fixes" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F40 | Next | `Refresh PC controlled-demo investor-readiness evidence after fixes` |' -Label "detailed queue F40"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F40 refresh PC controlled-demo investor-readiness evidence after fixes`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F40 refresh PC controlled-demo investor-readiness evidence after fixes`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F40 refresh PC controlled-demo investor-readiness evidence after fixes' -Label "handoff script F40 next task marker"
