...
Assert-Contains -Text $mobilePlan -Needle "F14 capture landscape-phone MechLab source-line evidence" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F14 | Next | `Capture landscape-phone MechLab source-line evidence` |' -Label "detailed queue F14"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F14 capture landscape-phone MechLab source-line evidence`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F14 capture landscape-phone MechLab source-line evidence`' -Label "handoff next planned work"
