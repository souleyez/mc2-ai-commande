...
Assert-Contains -Text $mobilePlan -Needle "F65 audit post-F64 PC controlled-demo investor route evidence refresh" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F65 | Next | `Audit post-F64 PC controlled-demo investor route evidence refresh` |' -Label "detailed queue F65"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F65 audit post-F64 PC controlled-demo investor route evidence refresh`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F65 audit post-F64 PC controlled-demo investor route evidence refresh`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F65 audit post-F64 PC controlled-demo investor route evidence refresh' -Label "handoff script F65 next task marker"
