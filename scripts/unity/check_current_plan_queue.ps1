...
Assert-Contains -Text $mobilePlan -Needle "F50 audit post-F49 PC controlled-demo investor route evidence refresh" -Label "mobile next task"
...
Assert-Contains -Text $detailedPlan -Needle '| F50 | Next | `Audit post-F49 PC controlled-demo investor route evidence refresh` |' -Label "detailed queue F50"

$handoff = Read-RequiredText -RelativePath "docs-machine-handoff-plan-2026-06-07.md"
Assert-Contains -Text $handoff -Needle 'Current formal next development task after handoff: `F50 audit post-F49 PC controlled-demo investor route evidence refresh`' -Label "handoff next task"
Assert-Contains -Text $handoff -Needle 'Next planned work: `F50 audit post-F49 PC controlled-demo investor route evidence refresh`' -Label "handoff next planned work"
...
Assert-Contains -Text $handoffScript -Needle 'F50 audit post-F49 PC controlled-demo investor route evidence refresh' -Label "handoff script F50 next task marker"
