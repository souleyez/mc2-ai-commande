...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F33 implement PC controlled-demo command readability and formation fixes`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F33 implement PC controlled-demo command readability and formation fixes`' -Label "handoff next planned work"
