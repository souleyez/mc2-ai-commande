...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F35 audit post-F34 PC controlled-demo playable flow polish`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F35 audit post-F34 PC controlled-demo playable flow polish`' -Label "handoff next planned work"
