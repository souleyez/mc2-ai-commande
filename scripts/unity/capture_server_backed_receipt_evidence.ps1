...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F28 capture Android entity placeholder collision runtime evidence`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F28 capture Android entity placeholder collision runtime evidence`' -Label "handoff next planned work"
