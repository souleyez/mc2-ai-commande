...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F23 capture landscape MechLab touch evidence`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F23 capture landscape MechLab touch evidence`' -Label "handoff next planned work"
