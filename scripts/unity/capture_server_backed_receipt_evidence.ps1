...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F22 audit landscape MechLab touch controls`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F22 audit landscape MechLab touch controls`' -Label "handoff next planned work"
