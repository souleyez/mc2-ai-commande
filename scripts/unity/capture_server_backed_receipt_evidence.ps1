...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F25 capture Android battle command touch evidence`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F25 capture Android battle command touch evidence`' -Label "handoff next planned work"
