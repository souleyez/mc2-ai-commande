...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F45 implement post-F44 PC controlled-demo investor evidence polish fixes`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F45 implement post-F44 PC controlled-demo investor evidence polish fixes`' -Label "handoff next planned work"
