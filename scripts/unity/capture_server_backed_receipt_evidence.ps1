...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F29 audit PC controlled-demo visual readability`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F29 audit PC controlled-demo visual readability`' -Label "handoff next planned work"
