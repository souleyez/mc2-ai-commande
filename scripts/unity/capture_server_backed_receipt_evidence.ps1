...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F24 capture Android MechLab touch evidence`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F24 capture Android MechLab touch evidence`' -Label "handoff next planned work"
