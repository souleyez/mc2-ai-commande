...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F32 audit PC controlled-demo command readability and formation feel`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F32 audit PC controlled-demo command readability and formation feel`' -Label "handoff next planned work"
