...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F19 capture opt-in post-receipt refresh evidence`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F19 capture opt-in post-receipt refresh evidence`' -Label "handoff next planned work"
