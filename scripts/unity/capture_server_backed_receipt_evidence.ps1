...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F26 reduce Android combat effect log noise`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F26 reduce Android combat effect log noise`' -Label "handoff next planned work"
