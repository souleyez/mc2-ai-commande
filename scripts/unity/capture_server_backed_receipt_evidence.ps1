...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F36 implement post-F34 PC controlled-demo playable flow polish fixes`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F36 implement post-F34 PC controlled-demo playable flow polish fixes`' -Label "handoff next planned work"
