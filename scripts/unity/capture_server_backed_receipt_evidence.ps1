...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F40 refresh PC controlled-demo investor-readiness evidence after fixes`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F40 refresh PC controlled-demo investor-readiness evidence after fixes`' -Label "handoff next planned work"
