...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F41 audit post-F40 PC controlled-demo investor evidence package`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F41 audit post-F40 PC controlled-demo investor evidence package`' -Label "handoff next planned work"
