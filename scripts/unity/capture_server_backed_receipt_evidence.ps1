...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F37 refresh PC controlled-demo playable-flow evidence after polish fixes`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F37 refresh PC controlled-demo playable-flow evidence after polish fixes`' -Label "handoff next planned work"
