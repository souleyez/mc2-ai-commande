...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F21 audit landscape touch UI ergonomics`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F21 audit landscape touch UI ergonomics`' -Label "handoff next planned work"
