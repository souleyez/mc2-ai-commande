...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F49 refresh PC controlled-demo investor route evidence after audit fixes`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F49 refresh PC controlled-demo investor route evidence after audit fixes`' -Label "handoff next planned work"
