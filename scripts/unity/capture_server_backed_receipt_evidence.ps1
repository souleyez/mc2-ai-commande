...
Require-Text -Text $handoffText -Needle 'Current formal next development task after handoff: `F39 implement post-F37 PC controlled-demo investor readiness fixes`' -Label "handoff next task"
Require-Text -Text $handoffText -Needle 'Next planned work: `F39 implement post-F37 PC controlled-demo investor readiness fixes`' -Label "handoff next planned work"
