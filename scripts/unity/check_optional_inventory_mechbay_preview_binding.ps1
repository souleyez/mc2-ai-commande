...
Require-Text -Text $queue -Needle "F22 audit landscape MechLab touch controls" -Label "queue next task"
...
Require-Text -Text $mobilePlan -Needle "F22 audit landscape MechLab touch controls" -Label "mobile next task"
