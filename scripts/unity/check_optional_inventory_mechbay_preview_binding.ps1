...
Require-Text -Text $queue -Needle "F15 plan server-backed receipt slice" -Label "queue next task"
...
Require-Text -Text $masterPlan -Needle '| 93 | Next | `Plan server-backed receipt slice` |' -Label "master F15 next"
...
Require-Text -Text $detailedPlan -Needle '| F15 | Next | `Plan server-backed receipt slice` |' -Label "detailed F15 next"
...
Require-Text -Text $mobilePlan -Needle "F15 plan server-backed receipt slice" -Label "mobile next task"
Require-Text -Text $mobilePlan -Needle "first phone version is landscape-only" -Label "mobile landscape invariant"
Require-Text -Text $handoff -Needle 'Current formal next development task after handoff: `F15 plan server-backed receipt slice`' -Label "handoff next task"
Require-Text -Text $handoff -Needle 'Next planned work: `F15 plan server-backed receipt slice`' -Label "handoff next planned work"
