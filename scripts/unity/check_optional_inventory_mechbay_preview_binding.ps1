...
Require-Text -Text $queue -Needle "F23 capture landscape MechLab touch evidence" -Label "queue next task"
...
Require-Text -Text $mobilePlan -Needle "F23 capture landscape MechLab touch evidence" -Label "mobile next task"
