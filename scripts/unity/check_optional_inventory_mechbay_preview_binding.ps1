...
Require-Text -Text $queue -Needle "F18 implement opt-in post-receipt inventory refresh binding" -Label "queue next task"
...
Require-Text -Text $mobilePlan -Needle "F18 implement opt-in post-receipt inventory refresh binding" -Label "mobile next task"
