...
Require-Text -Text $queue -Needle "F21 audit landscape touch UI ergonomics" -Label "queue next task"
...
Require-Text -Text $mobilePlan -Needle "F21 audit landscape touch UI ergonomics" -Label "mobile next task"
