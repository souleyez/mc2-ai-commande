...
Require-Text -Text $queue -Needle "F16 implement server-backed receipt evidence gate" -Label "queue next task"
...
Require-Text -Text $mobilePlan -Needle "F16 implement server-backed receipt evidence gate" -Label "mobile next task"
