...
Require-Text -Text $handoff -Needle 'Current formal next development task after handoff: `F31 refresh PC controlled-demo visual evidence after readability fixes`' -Label "handoff next task"
Require-Text -Text $handoff -Needle 'Next planned work: `F31 refresh PC controlled-demo visual evidence after readability fixes`' -Label "handoff next planned work"
