...
Require-Text -Text $queue -Needle "F14 capture landscape-phone MechLab source-line evidence" -Label "queue next task"
...
Require-Text -Text $masterPlan -Needle '| 92 | Next | `Capture landscape-phone MechLab source-line evidence` |' -Label "master F14 next"
...
Require-Text -Text $detailedPlan -Needle '| F14 | Next | `Capture landscape-phone MechLab source-line evidence` |' -Label "detailed F14 next"
...
Require-Text -Text $mobilePlan -Needle "F14 capture landscape-phone MechLab source-line evidence" -Label "mobile next task"
Require-Text -Text $mobilePlan -Needle "first phone version is landscape-only" -Label "mobile landscape invariant"
Require-Text -Text $handoff -Needle 'Current formal next development task after handoff: `F14 capture landscape-phone MechLab source-line evidence`' -Label "handoff next task"
Require-Text -Text $handoff -Needle 'Next planned work: `F14 capture landscape-phone MechLab source-line evidence`' -Label "handoff next planned work"
