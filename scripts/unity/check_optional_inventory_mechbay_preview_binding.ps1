...
Require-Text -Text $queue -Needle "F19 capture opt-in post-receipt refresh evidence" -Label "queue next task"
...
Require-Text -Text $mobilePlan -Needle "F19 capture opt-in post-receipt refresh evidence" -Label "mobile next task"
