...
Require-Text -Text $queue -Needle "F17 plan post-receipt inventory refresh boundary" -Label "queue next task"
...
Require-Text -Text $mobilePlan -Needle "F17 plan post-receipt inventory refresh boundary" -Label "mobile next task"
