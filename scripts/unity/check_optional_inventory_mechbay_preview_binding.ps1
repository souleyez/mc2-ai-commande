...
Require-Text -Text $handoff -Needle 'Current formal next development task after handoff: `F48 implement post-F47 PC controlled-demo investor route evidence audit fixes`' -Label "handoff next task"
Require-Text -Text $handoff -Needle 'Next planned work: `F48 implement post-F47 PC controlled-demo investor route evidence audit fixes`' -Label "handoff next planned work"
