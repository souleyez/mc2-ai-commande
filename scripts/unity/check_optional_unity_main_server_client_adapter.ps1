...
Require-Text -Text $handoff -Needle 'Current formal next development task after handoff: `F43 refresh PC controlled-demo investor evidence package after fixes`' -Label "handoff next task"
Require-Text -Text $handoff -Needle 'Next planned work: `F43 refresh PC controlled-demo investor evidence package after fixes`' -Label "handoff next planned work"
