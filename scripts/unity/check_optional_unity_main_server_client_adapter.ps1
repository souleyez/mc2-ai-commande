...
Require-Text -Text $handoff -Needle 'Current formal next development task after handoff: `F30 implement PC controlled-demo visual readability fixes`' -Label "handoff next task"
Require-Text -Text $handoff -Needle 'Next planned work: `F30 implement PC controlled-demo visual readability fixes`' -Label "handoff next planned work"
