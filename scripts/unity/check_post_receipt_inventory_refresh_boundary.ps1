...
foreach ($doc in $docs) {
    ...
    Require-Text -Text $doc.Text -Needle "F21 audit landscape touch UI ergonomics" -Label "$($doc.Name) F21 next marker"
}
...
Require-Text -Text $masterPlan -Needle '| 99 | Next | `Audit landscape touch UI ergonomics` |' -Label "master F21 next"
...
Require-Text -Text $detailedPlan -Needle '| F21 | Next | `Audit landscape touch UI ergonomics` |' -Label "detailed F21 next"
Require-Text -Text $handoff -Needle 'Current formal next development task after handoff: `F21 audit landscape touch UI ergonomics`' -Label "handoff next task"
Require-Text -Text $handoff -Needle 'Next planned work: `F21 audit landscape touch UI ergonomics`' -Label "handoff next planned work"
...
Require-Text -Text $queue -Needle "F21 audit landscape touch UI ergonomics" -Label "queue next F21"
