...
foreach ($doc in $docs) {
    ...
    Require-Text -Text $doc.Text -Needle "F23 capture landscape MechLab touch evidence" -Label "$($doc.Name) F23 next marker"
}
...
Require-Text -Text $masterPlan -Needle '| 101 | Next | `Capture landscape MechLab touch evidence` |' -Label "master F23 next"
...
Require-Text -Text $detailedPlan -Needle '| F23 | Next | `Capture landscape MechLab touch evidence` |' -Label "detailed F23 next"
Require-Text -Text $handoff -Needle 'Current formal next development task after handoff: `F23 capture landscape MechLab touch evidence`' -Label "handoff next task"
Require-Text -Text $handoff -Needle 'Next planned work: `F23 capture landscape MechLab touch evidence`' -Label "handoff next planned work"
...
Require-Text -Text $queue -Needle "F23 capture landscape MechLab touch evidence" -Label "queue next F23"
