...
$completedTaskName = "F70 refresh PC controlled-demo investor route evidence after F68 audit fixes"
$nextFormalTaskName = "F71 audit post-F70 PC controlled-demo investor route evidence refresh"
