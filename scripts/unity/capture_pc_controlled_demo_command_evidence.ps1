...
$completedTaskName = "F64 refresh PC controlled-demo investor route evidence after F62 audit fixes"
$nextFormalTaskName = "F65 audit post-F64 PC controlled-demo investor route evidence refresh"
