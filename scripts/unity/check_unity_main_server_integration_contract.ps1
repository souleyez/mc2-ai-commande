...
Require-Text -Text $handoff -Needle 'Current formal next development task after handoff: `F42 implement post-F41 PC controlled-demo investor evidence package fixes`' -Label "handoff next task"
Require-Text -Text $handoff -Needle 'Next planned work: `F42 implement post-F41 PC controlled-demo investor evidence package fixes`' -Label "handoff next planned work"
