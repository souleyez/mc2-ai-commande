...
Require-Text -Text $masterPlan -Needle '| 90 | Next | `Implement opt-in inventory-to-MechBay preview binding` |' -Label "master queue F12"
...
Require-Text -Text $detailedPlan -Needle "| F12 | Next | ``Implement opt-in inventory-to-MechBay preview binding`` |" -Label "detailed queue F12"
