...
本地 main-server 原型，F7 已写清 Unity 与主服务器的可选集成契约；正式下一
开发任务推进到 `F8 implement optional Unity main-server client adapter`。
...
`F5 server implementation boundary`, `F6 local main-server prototype` and
