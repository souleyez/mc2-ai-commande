...
launch/debrief smoke，F10 已接通 opt-in inventory bootstrap smoke；正式下一开发任务推进到
...
and that `F11 plan inventory-to-MechBay binding boundary` is the formal next task.
